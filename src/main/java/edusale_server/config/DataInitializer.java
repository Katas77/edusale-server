    ...
    public void run(String... args) {
        ...
        if (courseRepository.findAll().isEmpty()) {
            Course course1 = Course.builder()
                    ...
                    .text("Полный курс по Java от основ до продвинутого уровня. Изучите синтаксис, ООП, коллекции, streams и многое другое.")
                    .price("5000")
                    .rate("4.8")
            ...
            Course course2 = Course.builder()
                    .title("UX/UI Дизайн")
                    .text("Научитесь создавать красивые и удобные интерфейсы. Figma, прототипирование, пользовательское исследование.")
                    .price("7000")
                    .rate("4.9")
            ...
            Course course3 = Course.builder()
                    ...
                    .text("Стратегии продвижения в интернете. SMM, контекстная реклама, SEO, аналитика.")
                    .price("6000")
                    .rate("4.7")
